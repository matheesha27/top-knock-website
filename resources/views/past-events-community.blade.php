...
<body>
    ...
    <section class="past-events-content">
        ...
        <div class="event-gallery">
            <h1>SLCL Club League (Season 8)</h1>
            <div class="event-track" id="eventTrack">

                @php
                    $images = glob(public_path('images/past-event-4/*.jpeg'));
                @endphp

                @foreach ($images as $img)
                    <div class="event-img">
                        <img src="{{ asset('images/past-event-4/' . basename($img)) }}">
                    </div>
                @endforeach
        ...
        <!-- Event 2 -->
        <div class="event-gallery">
            <h1>SLCL Schools League (Season 2)</h1>
            <div class="event-track" id="eventTrack">

                @php
                    $images = glob(public_path('images/past-event-3/*.jpeg'));
                @endphp

                @foreach ($images as $img)
                    <div class="event-img">
                        <img src="{{ asset('images/past-event-3/' . basename($img)) }}">
                    </div>
                @endforeach
        ...
        <!-- Event 3 -->
        <div class="event-gallery">
            <h1>SLCL Masters League (Season 2)</h1>
            <div class="event-track">

                @php
                    $images = glob(public_path('images/past-event-2/*.jpeg'));
                @endphp

                @foreach ($images as $img)
                    <div class="event-img">
                        <img src="{{ asset('images/past-event-2/' . basename($img)) }}">
                    </div>
                @endforeach
        ...
        <!-- Event 4 -->
        <div class="event-gallery">
            <h1>SLCL Ramadan League (Season VI)</h1>
            <div class="event-track" id="eventTrack">
